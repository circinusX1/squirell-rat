...
public:
    ...
    static int Func0(HSKVM vm) {
        ...
        typedef R (*M)();
        M* method;
        __psq->getuserdata(vm, -1, (PVOID*)&method, NULL);
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 1) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 2) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 3) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 4) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 5) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 6) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 7) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 8) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 9) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 10) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 11) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 12) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 13) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (SCRAT_NO_ERROR_CHECKING)
        if (!SQRAT_CONST_CONDITION(overloaded) && __psq->gettop(vm) != startIdx + 14) {
            return __psq->throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
